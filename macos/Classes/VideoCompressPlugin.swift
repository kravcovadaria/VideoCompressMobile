...
public class VideoCompressPlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "compressVideo":
            let path = args!["path"] as! String
            let targetPath = call.arguments["targetPath"] as! String
            let quality = args!["quality"] as! NSNumber
            ...
            compressVideo(path, targetPath, quality, deleteOrigin, startTime, duration, includeAudio,
                          frameRate, result)
    ...
    private func compressVideo(_ path: String,_ targetPath: String,
                               _ quality: NSNumber,_ deleteOrigin: Bool,_ startTime: Double?,
